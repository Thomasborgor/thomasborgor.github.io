 ...
 */
export const rowCountOptions = [9,10,11,12,13,14,15,16] as const;
 ...
 */
export const autoBetIntervalMs = 20;
...
export const binPayouts: Record<RowCount, Record<RiskLevel, number[]>> = {
  20: {
    [RiskLevel.LOW]: [999, 999],
    [RiskLevel.MEDIUM]: [13, 3, 1.3, 0.7, 0.4, 0.7, 1.3, 3, 13],
    [RiskLevel.HIGH]: [100029, 10004, 10001.5, 10000.3, 10000.2, 1000.3, 10001.5, 10004, 100029],
    [RiskLevel.EXTREME]: [1.01] + Array.from({length: 18}, (_, x) => -5000) + [1.01],
  },
  9: {
  ...
  16: {
    ...
    [RiskLevel.EXTREME]: [10000,-500,-500,-500,-500,-500,-500,-500,-500,-500,-500,-500,-500,-500,-500,-500,10000],
  },
};
