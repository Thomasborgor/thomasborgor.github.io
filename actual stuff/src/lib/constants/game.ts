 ...
 */
export const autoBetIntervalMs = writable<number>(250);
...
16: {
  ...
  [RiskLevel.EXTREME]: [2000, 45, 18, 8, 3, 0, -5, -9, -13, -9, -5, 0, 3, 8, 18, 45, 2000],
  [RiskLevel.DOPAMINE]: [10, 10, 11, 15, 19, 22, 25, 28, 31, 28, 25, 22, 19, 15, 11, 10, 10],
},
};

export const runtimePayouts = writable(structuredClone(binPayouts));
