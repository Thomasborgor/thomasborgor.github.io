...
// node_modules/phosphor-svelte/lib/Question/Question.svelte
var file = "node_modules/phosphor-svelte/lib/Question/Question.svelte";
...
function create_if_block_5(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(path, "d", "M136,180a8,8,0,1,1-8-8A8,8,0,0,1,136,180ZM128,76c-19.85,0-36,14.36-36,32v4a4,4,0,0,0,8,0v-4c0-13.23,12.56-24,28-24s28,10.77,28,24-12.56,24-28,24a4,4,0,0,0-4,4v8a4,4,0,0,0,8,0v-4.2c18-1.77,32-15.36,32-31.8C164,90.36,147.85,76,128,76Zm100,52A100,100,0,1,1,128,28,100.11,100.11,0,0,1,228,128Zm-8,0a92,92,0,1,0-92,92A92.1,92.1,0,0,0,220,128Z");
      add_location(path, file, 40, 4, 2693);
    },
    m: function mount(target, anchor) {
...
function create_if_block_4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(path, "d", "M140,180a12,12,0,1,1-12-12A12,12,0,0,1,140,180ZM128,72c-22.06,0-40,16.15-40,36v4a8,8,0,0,0,16,0v-4c0-11,10.77-20,24-20s24,9,24,20-10.77,20-24,20a8,8,0,0,0-8,8v8a8,8,0,0,0,16,0v-.72c18.24-3.35,32-17.9,32-35.28C168,88.15,150.06,72,128,72Zm104,56A104,104,0,1,1,128,24,104.11,104.11,0,0,1,232,128Zm-16,0a88,88,0,1,0-88,88A88.1,88.1,0,0,0,216,128Z");
      add_location(path, file, 38, 4, 2303);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, path, anchor);
    },
...
function create_if_block_3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(path, "d", "M138,180a10,10,0,1,1-10-10A10,10,0,0,1,138,180ZM128,74c-21,0-38,15.25-38,34v4a6,6,0,0,0,12,0v-4c0-12.13,11.66-22,26-22s26,9.87,26,22-11.66,22-26,22a6,6,0,0,0-6,6v8a6,6,0,0,0,12,0v-2.42c18.11-2.58,32-16.66,32-33.58C166,89.25,149,74,128,74Zm102,54A102,102,0,1,1,128,26,102.12,102.12,0,0,1,230,128Zm-12,0a90,90,0,1,0-90,90A90.1,90.1,0,0,0,218,128Z");
      add_location(path, file, 36, 4, 1908);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, path, anchor);
    },
...
function create_if_block_2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(path, "d", "M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,168a12,12,0,1,1,12-12A12,12,0,0,1,128,192Zm8-48.72V144a8,8,0,0,1-16,0v-8a8,8,0,0,1,8-8c13.23,0,24-9,24-20s-10.77-20-24-20-24,9-24,20v4a8,8,0,0,1-16,0v-4c0-19.85,17.94-36,40-36s40,16.15,40,36C168,125.38,154.24,139.93,136,143.28Z");
      add_location(path, file, 34, 4, 1572);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, path, anchor);
    },
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(path0, file, 32, 4, 1109);
      attr_dev(path1, "d", "M140,180a12,12,0,1,1-12-12A12,12,0,0,1,140,180ZM128,72c-22.06,0-40,16.15-40,36v4a8,8,0,0,0,16,0v-4c0-11,10.77-20,24-20s24,9,24,20-10.77,20-24,20a8,8,0,0,0-8,8v8a8,8,0,0,0,16,0v-.72c18.24-3.35,32-17.9,32-35.28C168,88.15,150.06,72,128,72Zm104,56A104,104,0,1,1,128,24,104.11,104.11,0,0,1,232,128Zm-16,0a88,88,0,1,0-88,88A88.1,88.1,0,0,0,216,128Z");
      add_location(path1, file, 32, 77, 1182);
    },
    m: function mount(target, anchor) {
...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(path, "d", "M144,180a16,16,0,1,1-16-16A16,16,0,0,1,144,180Zm92-52A108,108,0,1,1,128,20,108.12,108.12,0,0,1,236,128Zm-24,0a84,84,0,1,0-84,84A84.09,84.09,0,0,0,212,128ZM128,64c-24.26,0-44,17.94-44,40v4a12,12,0,0,0,24,0v-4c0-8.82,9-16,20-16s20,7.18,20,16-9,16-20,16a12,12,0,0,0-12,12v8a12,12,0,0,0,23.73,2.56C158.31,137.88,172,122.37,172,104,172,81.94,152.26,64,128,64Z");
...
var Question = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
...
// node_modules/phosphor-svelte/lib/Question/index.js
var Question_default2 = Question_default;
export {
  Question_default2 as default
};
//# sourceMappingURL=phosphor-svelte_lib_Question.js.map
