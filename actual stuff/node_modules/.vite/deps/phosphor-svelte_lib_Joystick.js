...
// node_modules/phosphor-svelte/lib/Joystick/Joystick.svelte
var file = "node_modules/phosphor-svelte/lib/Joystick/Joystick.svelte";
...
function create_if_block_4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(path, "d", "M208,144H136V95.19a40,40,0,1,0-16,0V144H48a16,16,0,0,0-16,16v48a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V160A16,16,0,0,0,208,144ZM104,56a24,24,0,1,1,24,24A24,24,0,0,1,104,56ZM208,208H48V160H208v48Zm-40-96h32a8,8,0,0,1,0,16H168a8,8,0,0,1,0-16Z");
      add_location(path, file, 38, 4, 2022);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, path, anchor);
    },
...
function create_if_block_2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(path, "d", "M224,160v48a16,16,0,0,1-16,16H48a16,16,0,0,1-16-16V160a16,16,0,0,1,16-16h72V95.19a40,40,0,1,1,16,0V144h72A16,16,0,0,1,224,160Zm-64-40a8,8,0,0,0,8,8h32a8,8,0,0,0,0-16H168A8,8,0,0,0,160,120Z");
      add_location(path, file, 34, 4, 1440);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, path, anchor);
    },
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(path0, "d", "M216,160v48a8,8,0,0,1-8,8H48a8,8,0,0,1-8-8V160a8,8,0,0,1,8-8H208A8,8,0,0,1,216,160ZM128,88A32,32,0,1,0,96,56,32,32,0,0,0,128,88Z");
      attr_dev(path0, "opacity", "0.2");
      add_location(path0, file, 32, 4, 997);
      attr_dev(path1, "d", "M208,144H136V95.19a40,40,0,1,0-16,0V144H48a16,16,0,0,0-16,16v48a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V160A16,16,0,0,0,208,144ZM104,56a24,24,0,1,1,24,24A24,24,0,0,1,104,56ZM208,208H48V160H208v48Zm-40-96h32a8,8,0,0,1,0,16H168a8,8,0,0,1,0-16Z");
      add_location(path1, file, 32, 158, 1151);
    },
    m: function mount(target, anchor) {
...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(path, "d", "M208,144H140V98.32a44,44,0,1,0-24,0V144H48a20,20,0,0,0-20,20v44a20,20,0,0,0,20,20H208a20,20,0,0,0,20-20V164A20,20,0,0,0,208,144ZM108,56a20,20,0,1,1,20,20A20,20,0,0,1,108,56Zm96,148H52V168H204ZM172,104h32a12,12,0,0,1,0,24H172a12,12,0,0,1,0-24Z");
...
function instance($$self, $$props, $$invalidate) {
  ...
  validate_slots("Joystick", slots, ["default"]);
...
var Joystick = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
...
// node_modules/phosphor-svelte/lib/Joystick/index.js
var Joystick_default2 = Joystick_default;
export {
  Joystick_default2 as default
};
//# sourceMappingURL=phosphor-svelte_lib_Joystick.js.map
