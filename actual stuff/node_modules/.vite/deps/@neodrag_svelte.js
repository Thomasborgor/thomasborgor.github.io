...
function draggable(node, options = {}) {
  ...
  let { x: x_offset, y: y_offset } = position ? { x: (position == null ? void 0 : position.x) ?? 0, y: (position == null ? void 0 : position.y) ?? 0 } : defaultPosition;
  ...
  listen(
    ...
    (e) => {
      ...
      if (drag_els.some((el) => {
        var _a;
        return el.contains(event_target) || ((_a = el.shadowRoot) == null ? void 0 : _a.contains(event_target));
  ...
  return {
    ...
    update: (options2) => {
      ...
      if (is_controlled) {
        x_offset = translate_x = ((_a = options2.position) == null ? void 0 : _a.x) ?? translate_x;
        y_offset = translate_y = ((_b = options2.position) == null ? void 0 : _b.y) ?? translate_y;
        set_translate();
      }
    }
  };
